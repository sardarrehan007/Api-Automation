...
endpoint = "https://api.thegemnet.com/verify-stone"  # end_point
head = {"Authorization": "Bearer %s" % auth_token}  # auth_token

# Input Data

stone_id = input("Please Enter stone id : ")
...
json_file = open('verify_stone.json', 'w')
json_file.write(json_load)
json_file.close()

# JSON Read
json_file_read = open('verify_stone.json', 'r')
